...
from SheebaMusic.modules.play import generate_cover
from SheebaMusic.modules.play import arq
from SheebaMusic.modules.play import cb_admin_check
from SheebaMusic.modules.play import transcode
from SheebaMusic.modules.play import convert_seconds
from SheebaMusic.modules.play import time_to_seconds
from SheebaMusic.modules.play import changeImageSize
from SheebaMusic.config import BOT_NAME as bn
from SheebaMusic.config import DURATION_LIMIT
from SheebaMusic.config import UPDATES_CHANNEL as updateschannel
from SheebaMusic.config import que
from SheebaMusic.function.admins import admins as a
...
from SheebaMusic.services.callsmusic import callsmusic, queues
...
from SheebaMusic.services.downloaders import youtube
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @SheebaMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
